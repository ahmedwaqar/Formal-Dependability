...
val not_null_map = store_thm("not_null_map",
...
(*---------------*)
val rel_series_parallel_RBD_exp_dist_fail_rate = store_thm("rel_series_parallel_RBD_exp_dist_fail_rate",
...
(*-----------------------------*)
val rbd_virtual_cloud_server_alt_form = store_thm(
...
(*----------------------------*)
val rel_virtual_cloud_server = store_thm("rel_virtual_cloud_server",
...
(*---------------------------*)
val seq_rel_prod_tend_0 = store_thm("seq_rel_prod_tend_0",
...
++ (`(!n:num. (
  ...
  ++ RW_TAC std_ss[]);
(*--------rel_prod_tend_0----*)
val rel_prod_tend_0 = store_thm("rel_prod_tend_0",
...
(*------------------------*)
val bound_mult_ratr = store_thm("bound_mult_ratr",
...
++ RW_TAC real_ss[REAL_LT_NEG]);
(*-------------------------*)
val nlen_gen_list_eq_n1 = store_thm("nlen_gen_list_eq_n1",
...
(*-------------------------*)
val nlen_gen_list_eq_n = store_thm("nlen_gen_list_eq_n",
...
++ FULL_SIMP_TAC list_ss[]);
(*----------------------*)
val mem_flat_map_not_null3 = store_thm("mem_flat_map_not_null3",
...
(*-------------------------------*)
val mem_flat_fun_eq_mem_flat_null_list1 = store_thm(
...
++ METIS_TAC[]);
(*-------------------------------*)
val mem_flat_fun_eq_mem_flat_null_list3 = store_thm(
...
(*---------------------------*)
val nested_series_parallel_exp_dist = store_thm(
...
(*---------------------*)
val  cloud_server_rv_list_not_null1 = store_thm(
...
(*---------------------*)
val in_events_cloud_server_rv_list1 = store_thm("in_events_cloud_server_rv_list1",
...
++ RW_TAC list_ss[]);
(*---------------------*)
val len_cloud_server_fail_rate_eq_rv_list4 = store_thm(
...
++ RW_TAC list_ss[]);
(*---------------------*)
val len_cloud_server_fail_rate_eq_rv_list7 = store_thm(
...
val rel_parallel_series_exp_fail_rate = store_thm(
  "rel_parallel_series_exp_fail_rate",
  ``∀p t L C.
     (∀z. MEM z L ⇒ ¬NULL z) ∧ 0 ≤ t ∧ prob_space p ∧
     (∀x'.
